...
public class CurrencyConverter extends JFrame {
    ...
    public CurrencyConverter() {
        ...
        JButton btnGbp = new JButton("Convert");
        ...
        JButton btnAud = new JButton("Convert");
        ...
        JButton btnHkd = new JButton("Convert");
        ...
        JButton btnUsd = new JButton("Convert");
        ...
        JButton btnPkr = new JButton("Convert");
        ...
        JButton btnInr = new JButton("Convert");
        ...
        JButton btnQar = new JButton("Convert");
        ...
        JButton btnBdt = new JButton("Convert");
